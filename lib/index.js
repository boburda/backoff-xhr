...
exports.conn = function(method, successHandler, errorHandler) {
    ...
    this.retries = 0;
    this.maxRetries = 4;
    this.returnPromise = false;
    this.requestBody = undefined;
    this.jitter = 100;
    this.successHandler = successHandler ? successHandler : res => console.log(res);
    this.errorHandler = errorHandler ? errorHandler : res => console.log(res);
    // get/set for URL
